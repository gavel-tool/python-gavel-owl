...
public class TestDisjointClasses extends StandardAxiomTest {
    ...
    private static Stream<Arguments> provideTestCases() {
        ...
        return Stream.of(
            ...
            Arguments.of(
                df.getOWLDisjointClassesAxiom(testClass0, testClass1),
            ...
            //test Disjoint Classes nested
            Arguments.of(
                df.getOWLDisjointClassesAxiom(testClass0, (df.getOWLObjectSomeValuesFrom(testProperty0, testClass1))),
                new ArrayList<LogicElement>(Collections.singletonList(
                    new QuantifiedFormula(
                        new Quantifier(0),
                        new Variable[]{var0},
