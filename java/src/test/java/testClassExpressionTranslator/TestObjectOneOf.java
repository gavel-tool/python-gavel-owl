            ...
            Arguments.of(
                ...
                new BinaryFormula(
                    new BinaryFormula(
                        ...
                        df.getOWLThing().accept(new OWLClassExpressionTranslator(ind0.accept(new OWLIndividualTranslator())))
                    ),
                    new BinaryConnective(1), // disjunction
                    new BinaryFormula(
                        new BinaryFormula(variables[0], new BinaryConnective(8), new Constant(ind1.toStringID())),
                        new BinaryConnective(0), // conjunction
                        df.getOWLThing().accept(new OWLClassExpressionTranslator(ind1.accept(new OWLIndividualTranslator())))
                    )
                )
            ),
                ...
                new BinaryFormula(
                    ...
                    new BinaryFormula(
                        ...
                        new BinaryFormula(
                            ...
                            new BinaryConnective(0), // conjunction
                            df.getOWLThing().accept(new OWLClassExpressionTranslator(ind2.accept(new OWLIndividualTranslator())))
                        )
                    )
                )
            )
